...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{ asset('assets/admin/plugins/laravel-filemanager/img/72px color.png') }}">
...
<body>
  ...
  <script src="{{ asset('assets/admin/plugins/laravel-filemanager/js/cropper.min.js') }}"></script>
  <script src="{{ asset('assets/admin/plugins/laravel-filemanager/js/dropzone.min.js') }}"></script>
  <script>
